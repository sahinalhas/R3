...
export default function TwoCalendarSystem({ studentId, courses, subjectProgress }: TwoCalendarSystemProps) {
  ...
  const handleResizeMove = (e: React.PointerEvent) => {
    ...
    if (resizingSlot.edge === 'top') {
      ...
      // Minimum 30 dakika, maksimum saat 23:59
                        ...
                        return (
                          ...
                          >
                            ...
                            {isPreviewStart && dropPreview && previewHeight > 0 && (
                              <div 
                                className="absolute top-0 left-0 right-0 flex items-center justify-center bg-green-500/15 border-l-4 border-l-green-500 border border-green-500/40 rounded z-[5] pointer-events-none"
                            ...
                            {slot && isSlotStart && slotHeight > 0 && (
                              <div
                                className="absolute top-0 left-0 right-0 flex flex-col bg-primary/20 border-l-4 border-l-primary border border-primary/30 rounded cursor-move group z-10 hover:bg-primary/25 hover:border-primary/50 transition-colors overflow-hidden"
                              ...
                              >
                                {/* Resize handle - top */}
                                <div
                                  className="absolute -top-1 left-0 right-0 h-3 cursor-ns-resize flex items-center justify-center z-20 opacity-0 group-hover:opacity-100 transition-opacity"
                                ...
                                <div
                                  className="absolute -bottom-1 left-0 right-0 h-3 cursor-ns-resize flex items-center justify-center z-20 opacity-0 group-hover:opacity-100 transition-opacity"
