...
export default function AuthPage() {
  ...
  const handleDevLogin = async () => {
    try {
      ...
      toast({ title: "Giriş başarılı", description: `Hoş geldiniz, ${user.fullName}` });
      navigate("/");
    } catch (err: any) {
      toast({ title: "Hızlı giriş başarısız", description: err.message, variant: "destructive" });
    } finally {
