...
export default function SchoolInfoPage() {
  ...
  const schoolInfoQuery = useQuery({
    ...
    queryFn: () => apiRequest('/api/school-info'),
  });
  ...
  const updateMutation = useMutation({
    mutationFn: (data: SchoolInfoFormValues) => apiRequest('/api/school-info', { method: 'POST', data }),
    onSuccess: () => {
  ...
  return (
    <Layout title="Okul Bilgileri">
      <div className="mx-auto max-w-3xl p-4 sm:p-6 lg:p-8">
        <Card>
          <CardHeader>
            <CardTitle>Okul Bilgileri</CardTitle>
            <CardDescription>
              Rehberlik biriminizin bağlı olduğu okul bilgilerini buradan güncelleyebilirsiniz.
            </CardDescription>
          </CardHeader>
          <CardContent>
